            ...
            <div class="nano">
                <div class="nano-content">
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <?php
                            if($this->crud_model->vendor_permission('shipment')){
                        ?>
                        <!-- inventory -->
                        <li <?php if($page_name=="shipment"){?> class="active-link" <?php } ?> >
                            <a href="<?php echo base_url(); ?>vendor/shipment/">
                                <i class="fa fa-anchor"></i>
                                    <span class="menu-title">
                                        <?php echo translate('shipment');?>
                                    </span>
                            </a>
                        </li>
                        <!--inventory-->
