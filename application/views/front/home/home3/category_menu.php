                        ...
                        <div class="main-slider">
                            <div class="owl-carousel" id="main-slider">
                                ...
                                <div class="item slide<?php echo $i; ?> alt">
                                    <img class="slide-img image_delay img-responsive" src="<?php echo img_loading(); ?>" data-src="<?php echo $this->crud_model->file_view('slides',$row['slides_id'],'100','','no','src','','','.jpg') ?>" alt="" />
                                    <div class="caption">
                                        <div class="div-table">
                                            <div class="div-cell">
                                                <div class="caption-content">
                                                    <!-- <h1 class="text-center index-heading">Made for Designers</h1> -->
                                                    <p class="caption-text text-center">
                                                        <?php if($row['button_text']!=NULL){ ?>
                                                        <a class="btn" style="background:<?php echo $row['button_color']; ?>; color:<?php echo $row['text_color']; ?>; border-radius: 50px;" href="<?php echo $row['button_link']; ?>">
