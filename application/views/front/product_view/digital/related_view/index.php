        ...
        <div class="col-md-5 hidden-xs hidden-sm">
            <div class="row">
                <div class="col-md-2 others-img">
                    ...
                    ?>
                    <div class="related-product_pop" id="image<?php echo $i; ?>">
                        <img class="img-responsive img_related" data-src="<?php echo $thumbs[$id]; ?>" src="<?php echo $row1; ?>" alt=""/>
                    </div>
                    <?php
                        $i++;
                        }
                ...
                <div class="col-md-10">
                    <img class="img-responsive main-img" id="set_image_related" src="" alt=""/>
                </div>
            </div>
        </div>
        <div class="col-md-7">
...
<script>
    $(".img_related").click(function(){
        var src = $(this).data('src');
        $("#set_image_related").attr("src", src);
        $(".related-product_pop").removeClass("selected");
        $(this).closest(".related-product_pop").addClass("selected");
    });
    $(document).ready(function() {
        $("#image1").addClass("selected");
        var src=$("#image1").find(".img_related").data('src');
        $("#set_image_related").attr("src", src);
    });
